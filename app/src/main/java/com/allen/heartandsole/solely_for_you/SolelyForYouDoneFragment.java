...
public class SolelyForYouDoneFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        confetti.build()
                .addColors(ContextCompat.getColor(getContext(), R.color.colorPrimary),
                        ContextCompat.getColor(getContext(), R.color.lightBlue))
                .setDirection(0.0, 359.0)
                .setSpeed(1f, 5f)
                .setFadeOutEnabled(true)
                .setTimeToLive(2000L)
                .addShapes(Shape.Square.INSTANCE, new Shape.DrawableShape(
                        AppCompatResources.getDrawable(getContext(),
                                R.drawable.heart_and_sole_icon), false))
